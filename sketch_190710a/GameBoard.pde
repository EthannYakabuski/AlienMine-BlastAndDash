...
class GameBoard {
  ...
  void spawnAnEnemy(int frame) {
    ...
    if( (difficulty == 3600) &(currentBiome.equals("grassland"))) {
      ...
      //after two minutes in tropical do nothing
      //difficultyStepper = 4; 
      spawningMonkeys = true;
    ...
    if((difficulty == 5400) &(currentBiome.equals("grassland"))) {
      ...
      //after three minutes in tropical start spawning gorillas
      //difficultyStepper = 4; 
      spawningMonkeys = true;
      spawningGorillas = true;
    ...
    if ((difficulty == 10800) &(currentBiome.equals("grassland"))) {
      ...
      //after six minutes stop spawning gorillas
      //difficultyStepper = 4; 
      spawningMonkeys = false;
  ...
  void checkHiveBulletCollisions() {
  ...
  void introduceCannonBullet(int shootingAtX, int shootingAtY, int robotX, int robotY, int damage) {
  ...
  void introduceHiveBullet(int shootingAtX, int shootingAtY, int hiveX, int hiveY, int damage) {
 ...
 void generateBiome() {
  ...
  void plantTreesInTropicalBiome() {
